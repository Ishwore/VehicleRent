    ...
    return (
        ...
        <form onSubmit={collectData} className="inline-grid mt-28 rounded-3xl w-96  justify-center bg-stone-200">
            ...
            <div className=" inline-grid mt-2">
                <label htmlFor="username" className="text-left font-bold text-stone-500 mt-6">*Username*</label>
            ...
            < div className=" inline-grid mt-2">
                <label htmlFor="comfirmpassword" className="text-left font-bold text-stone-500">*Confirm Password*</label>
